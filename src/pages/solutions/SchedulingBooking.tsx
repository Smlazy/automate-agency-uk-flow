...
export default function SchedulingBooking() {
  const integrationTools = [
    'Calendly', 'Acuity', 'Google Calendar', 'Outlook', 'Zoom', 'Microsoft Teams',
    'Stripe', 'PayPal', 'SMS Platforms', 'Email Tools', 'Typeform', 'Booking.com'
  ];

  const achievements = [
    { title: 'Reduce no-shows by 60-80% through automated reminders', icon: Target },
    { title: 'Eliminate double-bookings and scheduling conflicts', icon: Check },
    { title: 'Capture payments at time of booking', icon: TrendingUp },
    { title: 'Provide 24/7 booking availability', icon: Clock },
    { title: 'Streamline rescheduling and cancellation processes', icon: Calendar }
  ];
  ...
  const processSteps = [
    {
      ...
      description: 'Connect all scheduling platforms and availability systems'
    },
    {
      step: '2',
      title: 'Booking Flow Design',
      description: 'Create seamless customer booking experience with payments'
    },
    {
      step: '3',
      title: 'Automated Confirmations',
      description: 'Set up reminder and confirmation sequences via email and SMS'
    },
    {
      step: '4',
      title: 'Payment Processing',
      description: 'Integrate secure payment collection at booking'
    }
  ];
  ...
  const industryExamples = [
    {
      ...
      description: 'Appointment booking, insurance verification, and pre-visit forms',
      benefits: ['Reduced admin time', 'Better patient experience', 'Automated forms']
    },
    {
      industry: 'Fitness Trainers',
      description: 'Class bookings, payment processing, and workout reminders',
      benefits: ['Increased bookings', 'Automated payments', 'Better retention']
    },
    {
      industry: 'Consultants',
      description: 'Discovery calls, proposal meetings, and follow-up scheduling',
      benefits: ['More qualified calls', 'Streamlined process', 'Better conversion']
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Automate your entire booking process from initial enquiry to post-appointment follow-up.
            </p>
